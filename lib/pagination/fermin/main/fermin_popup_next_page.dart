...
// Inject JavaScript code to calculate the content height
  ...
  Future<int> _onHeightWebView(BuildContext context) async {
    ...
    final int heightWebView =
        await controller.runJavaScriptReturningResult(script) as int;
  ...
  Future<MyData> fetchData() async {
    ...
    if (response.statusCode == 200) {
      return MyData.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
    } else {
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              ...
                              Item phones = Item(
                                  value: items.telefon, label: items.bezeichnung);
                          ...
                          Container(
                            ...
                            child: Row(children: [
                              ...
                              Container(
                                margin: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                                child: Text(
                                  "${"${items.strasse} - ${items.plz}"} ${items.ort}",
                                  style: const TextStyle(
                                      fontSize: 13,
                                      // Adjust the font size as needed
